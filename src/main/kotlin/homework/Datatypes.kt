...
// нужно писать прописными буквами
val v6 = FALSE
val v66: Boolean = false
...
// нельзя использовать такие кавычки, если хотелось строку нужны были ""
val v20 = `1.414`
...
// нельзя использовать такие кавычки, если хотелось символ нужны были ''
val v32 = “🤯”
